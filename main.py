...
c_maj_pent_scale = [41.2,
    ...
    1568,
    1760]
small_c_pent_scale = [261.6, 293.7, 329.6, 392, 440, 523.3]
basic.show_leds("""
    . # # # .
    # . . . .
    # . . . .
...
def on_forever():
    global hz
    if mode == 0:
        hz = c_maj_pent_scale[Math.floor(Math.map(pins.analog_read_pin(AnalogPin.P0),
                0,
                900,
                0,
                len(c_maj_pent_scale) - 1))]
    else:
        hz = Math.map(pins.analog_read_pin(AnalogPin.P0), 0, 900, 40, 1000)
